  ...
  function loadPage(data, index) {
    ...
    '<div id="task_' + (index + 1) + '" style="border-style: dotted; border-color: CornflowerBlue; padding: 10px; color:black">' +
      ...
      '<table class="table table-bordered table-striped">' +
        ...
        '</tbody>' +
      '</table>' +
      '<h4 style="text-align:center"> Note: 85% of people believe that System ' + data["bandwagon_order"] + ' is better. </h4>' +
      '<br>' +
...
function show_task(){
    ...
    <br>
    <h3><b style="color:red">ATTENTION</b>: Please be responsible for reaing all instruction, reference, and two systems' outputs and answer thoroughly. Each set is not same with the previous question.</h3>
    <hr>
    `
