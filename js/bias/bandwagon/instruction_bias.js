function show_instruction() {
    ...
    <hr>
		<p>
		In this study, you will be shown <b>a pair of answers generated by two systems A and B</b>, in addition to an instruction question and a reference sentence.
		</p>
    ...
    <hr>
        ...
        <div id="example_template" style="border-style: dotted; border-color: CornflowerBlue; padding: 10px; color:black">
            ...
            <h4 style="text-align:center"> Note: 85% of people believe that System A is better. </h4>
            <br>
